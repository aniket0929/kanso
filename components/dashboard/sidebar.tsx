    ...
    <div className="space-y-4 py-4 flex flex-col h-full bg-background border-r border-border/50 text-foreground">
      <div className="px-3 py-2 flex-1">
        <Link href="/dashboard" className="flex items-center pl-3 mb-14">
          <div className="text-2xl font-extrabold tracking-tighter font-logo">Kanso</div>
        </Link>
        <div className="space-y-1">
          {routes.map((route) => (
            <Link
              ...
              href={route.href}
              className={cn(
                "text-md group flex p-3 w-full justify-start font-medium cursor-pointer hover:bg-black/[0.03] rounded-lg transition",
